...
//Observer
interface User {
    void update(String mailingListName, String text);
}
...
class MailingListUser implements User {
    ...
    @Override
    public void update(String mailingListName, String text) {
...
class FilteredMailingListUser implements User {
    private String name, email, keyword;
