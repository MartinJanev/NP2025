...
//            Callable<String> callable = () -> callOpenAI(prompt);
...
//            String res = future.get(); // we can use timeout arguments here if desired - to avoid waiting forever
//            outputs.add(res);
            outputs.add(future.get(5, TimeUnit.SECONDS));
        }
